...
An outline for applying these processes across Microsoft services and products, along with further resources links, can be found at [Data Subject Requests and the GDPR][DSRforGDPR]. A DSR will typically call on three data types. Performing DSR tasks will vary depending on the data type. There are three basic types you will encounter.  
